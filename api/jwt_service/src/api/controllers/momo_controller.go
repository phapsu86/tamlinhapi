...
func (server *Server) PaymentMomo(w http.ResponseWriter, r *http.Request) {
	...
	var partnerCode = "MOMOZ3L320200829"
	var accessKey = "LdlUNdq6iKY5ChSa"
	var serectkey = "muqBXn7KtQ4Bb1yRWn0vyZjurqfIAb1z"
